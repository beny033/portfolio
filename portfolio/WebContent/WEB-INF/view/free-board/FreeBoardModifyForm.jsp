...
<body>
  <jsp:include page="/include/Header.jsp"/>
	...
	<div id="write_title"> <h3>글수정</h3></div>
  	<form action="freeBoardModify.htm?seq=${SEQ}" method="post" name="writeForm">
  	  <table>
		<tr id="writer">
		  <td class="col1">작성자/조회수</td>
		  <td class= "col2"><input type="text" name="writer" value="${WRITER }" readonly></td>
		</tr>
		
		<tr id="password">
		  <td class="col1">비밀번호(4자리)</td>
		  <td class= "col2"><input type="password" name="password" maxlength="4" autofocus required></td>
		</tr>
		...
		<tr id="content"> 
		  <td class = "col1">내용</td>
		  <td class = "col2"><textarea name="content" maxlength="20" required>${CONTENT }</textarea></td>
		</tr> 
